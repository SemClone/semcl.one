...
| **Binary Sniffer**<br/>*Identifies hidden OSS components embedded in binary files through signature matching* | 1.10.0 | MIT | ✅ Ready | GitHub (planned) · [PyPI](https://pypi.org/project/binarysniffer/) |
...
| **OSS License ID Library**<br/>*High-performance license detection across 700+ SPDX identifiers with confidence scores* | 1.2.6 | Apache-2.0 | ✅ Ready | GitHub (planned) · [PyPI](https://pypi.org/project/osslili/) |
...
| **Source to PURL**<br/>*Identifies package coordinates from source code using SWHIDs and multiple strategies* | 1.1.2 | AGPL-3.0 | ✅ Ready | GitHub (planned) · [PyPI](https://pypi.org/project/src2purl/) |
